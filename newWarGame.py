...
def announceWinner(playerOneWinner, playerTwoWinner, totalRounds, playerOneHand, playerTwoHand):
    ...
    if playerOneWinner == True:
        ...
        print(
            f"{winner} won in {totalRounds} total rounds and having a total of {len(playerOneHand)} cards!")
    else:
        winner = "Player Two"
        print("Player Two is the winner! Great Game!")
        print(
            f"{winner} won in {totalRounds} total rounds and having a total of {len(playerTwoHand)} cards!")
